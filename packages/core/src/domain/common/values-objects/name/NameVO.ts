...
export class NameVO {
  ...
  private static translate(key: string, i18n?: I18nAbstract, args?: Record<string, any>): string {
  ...
  private static defaultMessages(key: string, args?: Record<string, any>): string {
    const messages: Record<string, string> = {
      ...
      'errors.name.invalidChars': 'Apenas letras, espaços, apóstrofos e hífens são permitidos.',
    }
